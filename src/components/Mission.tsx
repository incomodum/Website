				...
				<div className="grid gap-12 lg:grid-cols-2">
					...
					>
						...
						<p className="mb-8 text-gray-600 text-lg">
							We're on a mission to continuously enhance and improve technology, delivering innovative software solutions that drive
							growth and success. We focus on optimizing what can be improved, creating value through collaboration, creativity, and
							excellence.
						</p>
						<div>
							<a
					...
					>
						...
						<div className="-bottom-4 -left-4 -rotate-12 absolute h-48 w-48 rounded-3xl bg-[#1a1b50]/10" />
					</motion.div>
				</div>
			</div>
		</section>
