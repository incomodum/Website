export default function Placeholder({ className }: { className: string }) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1200" fill="none" className={className}>
			<rect width="1200" height="1200" className="fill-[#EAEAEA] dark:fill-card" rx="3" />
			<g opacity=".5">
				<g opacity=".5">
					<path
						fill="#FAFAFA"
