...
export default function Header() {
	...
	return (
		<>
			<div className="sticky top-0 left-0 z-50 flex w-full flex-col bg-slate-50/50 backdrop-blur-xl lg:backdrop-blur-lg">
				<header className="flex w-full flex-row items-center justify-center p-8 pb-6 text-page">
					<div className="flex w-full max-w-7xl flex-row items-center justify-between">
						...
						<div className="relative isolate overflow-clip rounded-xl text-logo lg:hidden">
